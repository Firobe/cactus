...
type calibration = {
  ac1: Int16.t; ac2: Int16.t; ac3: Int16.t;
  ac4: Uint16.t; ac5: Uint16.t; ac6: Uint16.t;
  b1: Int16.t; b2: Int16.t;
  mb: Int16.t; mc: Int16.t; md: Int16.t
}
...
MC    %s
MD    %s"
    (to_string_hex cal.ac1)
    (to_string_hex cal.ac2)
    (to_string_hex cal.ac3)
    (Uint16.to_string_hex cal.ac4)
    (Uint16.to_string_hex cal.ac5)
    (Uint16.to_string_hex cal.ac6)
    (to_string_hex cal.b1)
    (to_string_hex cal.b2)
    (to_string_hex cal.mb)
    (to_string_hex cal.mc)
    (to_string_hex cal.md)

let get_new_raw_temperature i2c =
  assert ((I2c.write_byte_data i2c (Uint8.of_int 0xF4) (Uint8.of_int 0x2E) |> get_ok) = ());
  WiringPi.delay 6;
...
let init () =
  ...
  let i2c = match I2c.set_address fd i2c_address with
    | Result.Ok x -> x
